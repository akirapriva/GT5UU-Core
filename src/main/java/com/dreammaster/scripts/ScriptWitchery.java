...
public class ScriptWitchery implements IScriptLoader {
    ...
    public List<String> getDependencies() {
        return Arrays.asList(Witchery.ID);
    }
        ...
        if (BML) {
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            new ItemStack(Items.flint, 1),
                            getModItem(Botania.ID, "manaResource", 1, 2, missing))
                    .circuit(3).itemOutputs(getModItem(Witchery.ID, "ingredient", 2, 130, missing))
                    .duration(2 * SECONDS).eut(TierEU.RECIPE_LV / 2).addTo(mixerRecipes);
        }
        GTValues.RA.stdBuilder()
                .itemInputs(
        ...
        if (TML) {
            ...
            new ResearchItem(
                    ...
                    getModItem(Witchery.ID, "ingredient", 1, 153, missing))
                            .setPages(new ResearchPage("Witchery.research_page.ANOINTINGPASTE.1"))
            ...
            TCHelper.addResearchPage(
                    "OVEN",
                    new ResearchPage(
                            TCHelper.findArcaneRecipe(getModItem(Witchery.ID, "witchesovenidle", 1, 0, missing))));
            ...
            TCHelper.addResearchPage(
                    "SPINNINGWHEELW",
                    new ResearchPage(
                            TCHelper.findArcaneRecipe(getModItem(Witchery.ID, "spinningwheel", 1, 0, missing))));
            new ResearchItem(
                    "RUBYSLIPPERS",
                    "WITCHERY",
            ...
            TCHelper.addResearchPage(
                    "RUBYSLIPPERS",
                    new ResearchPage(
                            TCHelper.findInfusionRecipe(getModItem(Witchery.ID, "rubyslippers", 1, 0, missing))));
            ...
            new ResearchItem(
                    ...
                    0,
                    3,
                    getModItem(Witchery.ID, "distilleryidle", 1, 0, missing)).setParents("SPINNINGWHEELW")
                            .setConcealed().setPages(new ResearchPage("Witchery.research_page.DISTILLERY"))
                            .registerResearchItem();
            ThaumcraftApi.addArcaneCraftingRecipe(
                    "DISTILLERY",
            ...
            TCHelper.addResearchPage(
                    "DISTILLERY",
                    new ResearchPage(
                            TCHelper.findArcaneRecipe(getModItem(Witchery.ID, "distilleryidle", 1, 0, missing))));
            ...
            TCHelper.addResearchPage(
                    "CIRCLETALISMAN",
                    new ResearchPage(
                            TCHelper.findArcaneRecipe(getModItem(Witchery.ID, "circletalisman", 1, 0, missing))));
            ...
            new ResearchItem(
                    ...
                    0,
                    3,
                    getModItem(Witchery.ID, "ingredient", 1, 1, missing)).setParents("ALTAR", "ATTUNEDSTONE")
                            .setConcealed().setPages(new ResearchPage("Witchery.research_page.CHALICE"))
                            .registerResearchItem();
            ThaumcraftApi.addArcaneCraftingRecipe(
                    "CHALICE",
            ...
            TCHelper.addResearchPage(
                    "WARMBLOOD",
                    new ResearchPage(
                            TCHelper.findCrucibleRecipe(getModItem(Witchery.ID, "ingredient", 1, 163, missing))));
            ...
            new ResearchItem(
                    ...
                    4,
                    3,
                    getModItem(Witchery.ID, "filteredfumefunnel", 1, 0, missing)).setParents("FUMEFILTER")
                            .setConcealed().setPages(new ResearchPage("Witchery.research_page.FILTEREDFUMEFUNNEL"))
                            .registerResearchItem();
            TCHelper.addInfusionCraftingRecipe(
                    "FILTEREDFUMEFUNNEL",
            ...
            TCHelper.addResearchPage(
                    "WAYSTONE",
                    new ResearchPage(
                            TCHelper.findInfusionRecipe(getModItem(Witchery.ID, "ingredient", 1, 12, missing))));
