...
public class ScriptTCCoreMod implements IScriptLoader {
    ...
    public List<String> getDependencies() {
        return Arrays.asList(Thaumcraft.ID);
    }
    ...
    public void loadRecipes() {
        ...
        if (XUML) {
            ...
            new ResearchItem(
                    ...
                    getModItem(ExtraUtilities.ID, "angelBlock", 1, 0, missing)).setParents("MAGICALWOOD").setConcealed()
                            .setPages(new ResearchPage("ExtraUtilities.research_page.ANGELBLOCK"))
                            .registerResearchItem();
            if (AMAGYML && ICML) {
                ThaumcraftApi.addArcaneCraftingRecipe(
                        "ANGELBLOCK",
        ...
        if (DEML) {
            new ResearchItem(
                    ...
                    getModItem(DraconicEvolution.ID, "dissEnchanter", 1, 0, missing)).setParents("ENCHANTINGTABLE")
                            .setConcealed()
                            .setPages(new ResearchPage("DraconicEvolution.research_page.DISENCHANTINGTABLE"))
                            .registerResearchItem();
            ThaumcraftApi.addArcaneCraftingRecipe(
                    "DISENCHANTINGTABLE",
        ...
        if (MBML) {
            ...
            TCHelper.addResearchPage(
                    "DRAGONEGG",
                    new ResearchPage(
                            TCHelper.findInfusionRecipe(getModItem(Minecraft.ID, "dragon_egg", 1, 0, missing))));
        ...
        if (TCML) {
            new ResearchItem(
                    ...
                    getModItem(TinkerConstruct.ID, "materials", 1, 26, missing)).setParents("ENCHANTINGTABLE")
                            ...
                            .setPages(new ResearchPage("TConstruct.research_page.SILKYCRYSTAL")).registerResearchItem();
            ThaumcraftApi.addArcaneCraftingRecipe(
                    "SILKYCRYSTAL",
            ...
            new ResearchItem(
                    ...
                    -2,
                    3,
                    getModItem(TinkerConstruct.ID, "materials", 1, 7, missing)).setParents("ENCHANTINGTABLE")
                            .setConcealed().setRound()
                            .setPages(new ResearchPage("TConstruct.research_page.LAVACRYSTAL")).registerResearchItem();
            TCHelper.addInfusionCraftingRecipe(
                    "LAVACRYSTAL",
            ...
            new ResearchItem(
                    ...
                    getModItem(TinkerConstruct.ID, "materials", 1, 6, missing))
                            ...
                            .setPages(new ResearchPage("TConstruct.research_page.BALLOFMOSS")).registerResearchItem();
            if (BOPML && TFML) {
                TCHelper.addInfusionCraftingRecipe(
                        "BALLOFMOSS",
                        getModItem(TinkerConstruct.ID, "materials", 1, 6, missing),
            ...
            new ResearchItem(
                    ...
                    getModItem(TinkerConstruct.ID, "materials", 1, 8, missing))
                            ...
                            .setConcealed().setRound()
                            .setPages(new ResearchPage("TConstruct.research_page.NECROTICBONE")).registerResearchItem();
            ...
            new ResearchItem(
                    ...
                    -8,
                    3,
                    getModItem(TinkerConstruct.ID, "heartCanister", 1, 2, missing)).setParents("REDHEART")
                            .setConcealed().setPages(new ResearchPage("TConstruct.research_page.REDHEARTCANISTER.1"))
                            .registerResearchItem();
            ThaumcraftApi.addArcaneCraftingRecipe(
                    "REDHEARTCANISTER",
            ...
            new ResearchItem(
                    ...
                    -7,
                    3,
                    getModItem(TinkerConstruct.ID, "heartCanister", 1, 3, missing)).setParents("REDHEART")
                            .setConcealed().setRound()
                            .setPages(new ResearchPage("TConstruct.research_page.YELLOWHEART.1"))
                            .registerResearchItem();
            TCHelper.addInfusionCraftingRecipe(
                    "YELLOWHEART",
            ...
            new ResearchItem(
                    ...
                    -9,
                    3,
                    getModItem(TinkerConstruct.ID, "heartCanister", 1, 4, missing)).setParents("YELLOWHEART")
                            .setConcealed().setPages(new ResearchPage("TConstruct.research_page.YELLOWHEARTCANISTER.1"))
                            .registerResearchItem();
            ThaumcraftApi.addArcaneCraftingRecipe(
                    "YELLOWHEARTCANISTER",
            ...
            new ResearchItem(
                    ...
                    -7,
                    3,
                    getModItem(TinkerConstruct.ID, "heartCanister", 1, 5, missing)).setParents("YELLOWHEART")
                            .setConcealed().setRound()
                            .setPages(new ResearchPage("TConstruct.research_page.GREENHEART.1")).registerResearchItem();
            TCHelper.addInfusionCraftingRecipe(
                    "GREENHEART",
            ...
            new ResearchItem(
                    ...
                    -9,
                    3,
                    getModItem(TinkerConstruct.ID, "heartCanister", 1, 6, missing)).setParents("GREENHEART")
                            .setConcealed()
                            .setPages(
        ...
        if (ESML) {
            ...
            TCHelper.addResearchPage(
                    "ENDERCHEST",
                    new ResearchPage(
                            TCHelper.findArcaneRecipe(getModItem(EnderStorage.ID, "enderChest", 1, 0, missing))));
            new ResearchItem(
                    "ENDERTANK",
                    "NEWHORIZONS",
                    new AspectList().add(Aspect.getAspect("metallum"), 15).add(Aspect.getAspect("electrum"), 15)
            ...
            new ResearchItem(
                    ...
                    getModItem(EnderStorage.ID, "enderPouch", 1, 0, missing)).setParents("ENDERTANK").setConcealed()
                            .setPages(new ResearchPage("EnderStorage.research_page.ENDERPOUCHE"))
                            .registerResearchItem();
            if (BPML) {
                ThaumcraftApi.addArcaneCraftingRecipe(
                        "ENDERPOUCHE",
            ...
            TCHelper.addResearchPage(
                    "ENDERPOUCHE",
                    new ResearchPage(
                            TCHelper.findArcaneRecipe(getModItem(EnderStorage.ID, "enderPouch", 1, 0, missing))));
        }
        if (OML) {
            new ResearchItem(
                    "AUTOENCHANTINGTABLE",
        ...
        if (AML) {
            new ResearchItem(
                    ...
                    4,
                    3,
                    getModItem(Avaritia.ID, "Skull_Sword", 1, 0, missing)).setParents("INFUSION").setConcealed()
                            .setRound().setPages(new ResearchPage("Avaritia.research_page.SFSWORD.1"))
                            .registerResearchItem();
            if (TFML && TCML) {
                TCHelper.addInfusionCraftingRecipe(
                        "SFSWORD",
            ...
            TCHelper.addResearchPage(
                    "SFSWORD",
                    new ResearchPage(
                            TCHelper.findInfusionRecipe(getModItem(Avaritia.ID, "Skull_Sword", 1, 0, missing))));
        ...
        if (TTML) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidOutputs(Materials.HellishMetal.getMolten(4 * STACKS)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_UV).metadata(DEFC_CASING_TIER, 1).addTo(fusionCraftingRecipes);
        }
