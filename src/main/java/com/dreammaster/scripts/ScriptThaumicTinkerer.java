...
public class ScriptThaumicTinkerer implements IScriptLoader {
    ...
    public List<String> getDependencies() {
        return Arrays.asList(Thaumcraft.ID, ThaumicTinkerer.ID);
    }
